...
function analyzeAsset(name, value) {
    ...
    // 1. CARS
    if (lowercaseName.includes('nissan') || lowercaseName.includes('toyota') ||
        ...
        if (lowercaseName.includes('nissan') || lowercaseName.includes('نيسان') || lowercaseName.includes('sunny'))
            brand = 'Nissan';
        else if (lowercaseName.includes('toyota') || lowercaseName.includes('تويوتا') || lowercaseName.includes('corolla'))
            brand = 'Toyota';
        else if (lowercaseName.includes('hyundai') || lowercaseName.includes('هيونداي'))
            brand = 'Hyundai';
    ...
    // 2. GOLD
    else if (lowercaseName.includes('gold') || lowercaseName.includes('ذهب') ||
        ...
        if (lowercaseName.includes('24'))
            gold_purity = '24K';
        else if (lowercaseName.includes('21'))
            gold_purity = '21K';
        else if (lowercaseName.includes('18'))
            gold_purity = '18K';
        else
            gold_purity = '21K'; // default
    }
    // 3. REAL ESTATE
    else if (lowercaseName.includes('apartment') || lowercaseName.includes('house') ||
        ...
        confidence = 0.8;
        if (lowercaseName.includes('تجمع') || lowercaseName.includes('tagamoa'))
            region = 'New Cairo';
        else if (lowercaseName.includes('زايد') || lowercaseName.includes('zayed'))
            region = 'Sheikh Zayed';
        else if (lowercaseName.includes('أكتوبر') || lowercaseName.includes('october'))
            region = '6th of October';
        else
            region = 'Cairo Metropolitan';
    }
    // 4. CASH
    ...
    // 5. STOCKS / CRYPTO
    else if (lowercaseName.includes('stock') || lowercaseName.includes('crypto') ||
